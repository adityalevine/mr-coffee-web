      ...
      <section className="pt-20 pb-10">
        <div className="container mx-auto px-8 space-y-10">
          ...
          <div className="space-y-10 max-w-3xl mx-auto">
            {/* Sejarah Perkembangan Section Start */}
            <section>
              <div className="bg-[#fcf0f0] border rounded-xl shadow p-6">
                <h2 className="text-xl font-bold mb-4 text-[#693D3D]">
                  Sejarah Perkembangan
                </h2>
                <p className="text-[#693D3D] text-sm leading-relaxed">
                  Mr. Coffee berdiri sejak tahun 1970, dimulai dari sebuah kedai
                  kopi kecil namun klasik yang dikenal karena pesonanya yang
                  unik dan aroma kopi segar yang diseduh. Seiring waktu, kami
            ...
            {/* Sejarah Perkembangan Section End */}

            {/* Visi Section Start */}
            <section>
              <div className="bg-[#fcf0f0] border rounded-xl shadow p-6">
                <h2 className="text-xl font-bold mb-4 text-[#693D3D]">Visi</h2>
                <p className="text-[#693D3D] text-sm leading-relaxed">
                  ...
                  menginspirasi koneksi, kreativitas, dan komunitas di antara
                  para pecinta kopi.
                </p>
              </div>
            </section>
            ...
            <section>
              <div className="bg-[#fcf0f0] border rounded-xl shadow p-6">
                <h2 className="text-xl font-bold mb-4 text-[#693D3D]">Misi</h2>
            ...
            <section>
              <div className="bg-[#fcf0f0] border rounded-xl shadow p-6">
                ...
                <p className="text-[#693D3D] text-sm leading-relaxed mb-4">
                  Dengan latar belakang sebagai barista berpengalaman dan
                  seorang pengusaha yang berorientasi pada komunitas, Liman
                  telah berhasil mengubah MR.COFFEE menjadi tempat yang dicintai
                  oleh banyak orang di kota.
                </p>
                <p className="text-[#693D3D] text-sm leading-relaxed">
            ...
            <section>
              <div>
                <h2 className="text-xl font-bold mb-6 text-center text-[#693D3D]">
                  Team Management
                </h2>
